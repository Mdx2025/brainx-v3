# 🛡️ BrainX V3 - Guía de Resiliencia y Disaster Recovery
...
|------------|-----------|--------|---------|
| **PostgreSQL Database** | `postgresql://localhost:5432/brainx_v3` | 🔴 ALTO | 🔴 CRÍTICO - Todas las memorias |
...
| **Skill Files** | `~/.openclaw/skills/brainx-v3/` | 🟢 BAJO | 🟢 Reinstalable desde GitHub |
...
├── brainx_v3_database.sql          ← 🔴 Datos críticos (dump PostgreSQL)
├── METADATA.json                   ← 📋 Info del backup
├── config/
│   ├── brainx-v3-skill/           ← 📁 Skill completo
